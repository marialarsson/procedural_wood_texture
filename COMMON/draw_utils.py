...
def draw_cuboid_with_procedural_texture(shader, inds, t, offset=0,  xrot0=-math.pi/5, yrot0=math.pi/4, zrot0=0.0, xrotf=0.0, yrotf=0.0, zrotf=0.0):
    ...
    #glDrawElements(GL_TRIANGLES, 3, GL_UNSIGNED_INT, ctypes.c_void_p(offset * inds.itemsize))
    #glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, ctypes.c_void_p(0))
    #glDrawElements(GL_LINES, 8, GL_UNSIGNED_INT, ctypes.c_void_p(0))
